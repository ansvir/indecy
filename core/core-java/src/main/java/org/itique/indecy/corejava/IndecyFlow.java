...
import org.itique.indecy.coregroovy.dsl.Branch;
import org.itique.indecy.coregroovy.dsl.Case;
...
import static org.itique.indecy.coregroovy.dsl.constant.TargetStrategy.FINAL_CASE;
...
public class IndecyFlow {
    ...
    public static class Runner extends IndecyContext {
        ...
        public static class Builder {
            ...
            public Runner create(String path, String script) {
                try {
                    File scriptFile = new File(path);
                    Files.write(Paths.get(scriptFile.toURI()), script.getBytes(StandardCharsets.UTF_8));
                    return new Runner(params, initValue, scriptFile);
                } catch (IOException e) {
                    throw new RuntimeException("Cannot create file from provided content, cause: " + e);
                }
            }
        }
    }
